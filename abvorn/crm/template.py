...
<table role="presentation" width="600" class="container" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:8px;overflow:hidden;max-width:100%">

<!-- Header -->
<tr><td class="header" style="background-color:#1a1a1a;padding:24px 32px">
<table role="presentation" width="100%" cellpadding="0" cellspacing="0">
<tr>
<td style="color:#ffffff;font-size:20px;font-weight:700;letter-spacing:-0.5px">Abvorn</td>
<td style="color:#888;font-size:12px;text-align:right">Honest Reviews</td>
</tr>
</table>
</td></tr>
...
<h1 class="greeting" style="margin:0 0 8px;font-size:24px;color:#1a1a1a;font-weight:700">Hi {to_name},</h1>
{body_html}
{cta_block}
{lead_magnet_block}
</td></tr>
...
<!-- Footer -->
<tr><td class="footer" style="background-color:#fafaf8;padding:24px 32px;border-top:1px solid #e5e5e5">
...
<tr>
<td class="cta" style="background-color:#1a1a1a;border-radius:6px;padding:12px 28px;text-align:center">
...
<tr>
<td style="background-color:#1a1a1a;border-radius:4px;padding:8px 20px">
