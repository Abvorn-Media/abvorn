...
def make_nav_html(current_slug=None):
    ...
    return f'<nav><div class="inner"><a class="logo" href="{SITE_BASE}/"><img src="{SITE_BASE}/assets/logo.png" alt="Abvorn">Abvorn</a><button class="hamburger" aria-label="Menu" aria-expanded="false" aria-controls="main-nav">☰</button><div class="nav-links" id="main-nav">{featured_links}{dropdown}</div></div></nav>'
...
<link rel="apple-touch-icon" href="{SITE_BASE}/assets/logo.png">
