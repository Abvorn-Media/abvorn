...
<head>
    ...
    <style>
        ...
        .hero-slide .hero-verdict { position:absolute; left:10px; right:10px; bottom:10px; background:rgba(13,13,13,0.34); backdrop-filter:blur(4px); color:#fff; border:1px solid rgba(255,255,255,0.1); border-radius:10px; padding:8px 12px 10px; box-shadow:0 6px 20px rgba(0,0,0,0.25); }
