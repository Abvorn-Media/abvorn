---
name: win-conversion-optimizer
description: Scoped loop execution skill for Conversion Optimizer. Use when win.sh or win-loops gives a run brief for this loop.
---

<!-- Installed by win-loops for codex. This is a scoped loop execution skill. -->

# Conversion Optimizer Executor
...
- The loop contract from `.win/loops/conversion-optimizer/LOOP.md`.
