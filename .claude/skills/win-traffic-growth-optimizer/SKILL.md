---
name: win-traffic-growth-optimizer
description: Scoped loop execution skill for Traffic Growth Optimizer. Use when win.sh or win-loops gives a run brief for this loop.
---

<!-- Installed by win-loops for codex. This is a scoped loop execution skill. -->

# Traffic Growth Optimizer Executor
...
- The loop contract from `.win/loops/traffic-growth-optimizer/LOOP.md`.
